    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-xl md:text-2xl font-bold text-slate-900">Savings Goals</h1>
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-5 py-2.5 rounded-xl font-bold transition-all shadow-lg shadow-emerald-200 w-full md:w-auto"
                >
                    <Plus size={20} />
                    Add Savings Goal
                </button>
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-end justify-between">
                                        ...
                                        <span className="text-xs text-slate-400 font-medium">Goal: ₹{goal.target_amount.toLocaleString()}</span>
                                    </div>
